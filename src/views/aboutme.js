const About = () => {
 ...
 <div id="root">
    <div class="container-about">
        ...
        <div class="about2">
        <a href="https://github.com/Slacusc" Target="_blank"><img class="icon3"  src="https://github.com/Slacusc/Portafolio/blob/main/src/assets/icongit.png?raw=true" alt="github image"></a>
        ...
        <div class="about6">
        <img class="bio-photo" src="./src/assets/biofoto.png" alt="biophoto">
        </div>
    </div>
